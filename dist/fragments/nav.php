  ...
  <div class="container px-4 px-lg-5">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav ms-auto py-4 py-lg-0">
        ...
        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="create-post.php">Create New Blog Post</a></li>
        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="my-posts.php">My Blog Posts</a></li>
