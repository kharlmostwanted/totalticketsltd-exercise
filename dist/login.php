...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="indexphp">TotalTickets LTD</a>
                ...
                <div class="col-md-10 col-lg-8 col-xl-7">
                    ...
                    <div class="my-5">
                        ...
                        <form method="post" id="contactForm" action="">
                            ...
                            <div class="form-floating">
                                <input class="form-control" name="password" id="password" type="password" placeholder="Enter your email..." data-sb-validations="required,email" />
                            ...
                            <br />
                            <!-- Submit Button-->
                            <button class="btn btn-primary text-uppercase" name="login" id="submitButton" type="submit">login</button>
                        </form>
                    </div>
                </div>
            </div>
